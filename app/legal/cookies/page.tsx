        ...
        <div className="bg-white rounded-xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-slate-700 mb-8">
              La información recopilada mediante cookies se gestiona conforme a la normativa europea aplicable y se
              describe de forma detallada en la presente Política de Cookies.
            </p>
