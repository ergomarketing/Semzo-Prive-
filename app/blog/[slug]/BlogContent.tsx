        ...
        <div className="relative w-full aspect-[16/9] md:aspect-[21/9] bg-indigo-dark">
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="container mx-auto max-w-4xl p-8">
              ...
              <Badge className="bg-rose-pastel text-indigo-dark mb-4">{t("badge")}</Badge>
          ...
          <div className="container mx-auto max-w-3xl px-4">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <div className="flex items-center justify-between">
                <p className="text-indigo-dark/60">{t("likedArticle")}</p>
                <ShareMenu
                  title={post.title}
                  slug={slug}
            ...
            <div className="mt-12 p-8 bg-rose-nude rounded-2xl text-center">
              <h3 className="text-2xl font-serif text-indigo-dark mb-4">{t("ctaTitle")}</h3>
