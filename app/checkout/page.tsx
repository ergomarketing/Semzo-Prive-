...
import { ArrowLeft, ShoppingBag, Check, Gift, CreditCard } from "lucide-react"
...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      let price = 129
      let name = "Signature"
      let description = "Membresía mensual Signature"
      ...
      const couponType = params.get("couponType")
      ...
      if (couponCode && couponDiscount) {
        ...
        setAppliedCoupon({ code: couponCode, discount, type: couponType || "percent" })
  ...
  const handleZeroAmountCheckout = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setErrorMessage("Error al activar membresía")
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-between">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs mt-2">{finalAmount === 0 ? "Confirmación" : "Pago"}</span>
              </div>
                  ...
                  <div className="space-y-6">
                    ...
                    {appliedGiftCard && (
                      <div className="flex items-center justify-between text-green-600">
                        ...
                        <span>-{Math.min(appliedGiftCard.balance, selectedPlan.price)}€</span>
                      </div>
                    )}
                    ...
                    {finalAmount === 0 && (
                      <div className="bg-green-50 p-4 rounded-lg">
                        <div className="flex items-center gap-2 text-green-700">
                          ...
                          <span className="font-medium">Tu pedido está completamente cubierto</span>
                        </div>
                        <p className="text-sm text-green-600 mt-1">
                          No se realizará ningún cargo. Tu membresía se activará inmediatamente.
                        </p>
                      </div>
                    )}
